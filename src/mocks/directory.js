 ...
 * personnes. Quand l'écran d'Adam existera, on remplacera l'implémentation de
 * `searchDirectory` par un appel à son service.
 */
const PEOPLE = [
...
export function getDirectoryUser(id) {
