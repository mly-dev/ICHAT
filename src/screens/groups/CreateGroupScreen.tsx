...
export function CreateGroupScreen() {
  ...
  const toggleMember = useCallback((user: UserSummary) => {
    setMembers((current) =>
  ...
  const submit = useCallback(async () => {
    ...
    // On remplace l'écran de création : revenir en arrière depuis le groupe
    ...
    <Screen>
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <View style={styles.footer}>
          <Button label="Créer le groupe" onPress={submit} disabled={!canSubmit} loading={creating} />
        </View>
