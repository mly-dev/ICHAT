...
const ACCESSIBLE_LABELS: Record<MessageStatus, string> = {
...
export const MessageStatusIcon = memo(function MessageStatusIcon({ status }: { status: MessageStatus }) {
  return (
    <Text
      style={[styles.base, status === 'read' ? styles.read : null, status === 'failed' ? styles.failed : null]}
